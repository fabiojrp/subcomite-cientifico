        ...
        for municipio, linha in dict_municipios.items():
            ...
            for i in range(0, len(listaDatas)):
                ...
                if i >= self.diasMediaMovel:
                    ...
                    sumMediaMovelcasos -= listaDatas[i-self.diasMediaMovel][1]['casos']

                    sumMediaMovelobitos += listaDatas[i][1]['obitos']
                    sumMediaMovelobitos -= listaDatas[i-self.diasMediaMovel][1]['obitos']
                ...
                if i>= self.diasVariacaoMediaMovel-1:
                    ...
                    if listaDatas[i][1]['casos_mediaMovel'] == 0 or listaDatas[i-self.diasVariacaoMediaMovel][1]['casos_mediaMovel'] == 0:
                        variacaoCasosMediaMovel = 0.00000
                    else:
                        variacaoCasosMediaMovel = (listaDatas[i][1]['casos_mediaMovel']/listaDatas[i-self.diasVariacaoMediaMovel][1]['casos_mediaMovel'] -1)*100
                    
                    listaDatas[i][1]['variacao_mediaMovel_casos'] = variacaoCasosMediaMovel
