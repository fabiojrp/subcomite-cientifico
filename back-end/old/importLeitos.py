...
with open('Leitos COVID - histórico - Leitos Geral+Covid.csv', 'r') as arquivo_leitos:
...
with open('Leitos COVID - histórico - Apenas leitos COVID.csv', 'r') as arquivo_leitos:
    hospitais = csv.DictReader(arquivo_leitos, delimiter=",")
